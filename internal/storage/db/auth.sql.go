...
RETURNING id, email, email_verified, name, picture, password_hash, provider, google_id, failed_login_attempts, locked_until, created_at, updated_at, email_verification_token_hash, email_verification_expires_at
`
...
SELECT id, email, email_verified, name, picture, password_hash, provider, google_id, failed_login_attempts, locked_until, created_at, updated_at, email_verification_token_hash, email_verification_expires_at FROM users WHERE email = $1
`
...
SELECT id, email, email_verified, name, picture, password_hash, provider, google_id, failed_login_attempts, locked_until, created_at, updated_at, email_verification_token_hash, email_verification_expires_at
FROM users
WHERE email_verification_token_hash = $1
`

func (q *Queries) GetUserByEmailVerificationTokenHash(ctx context.Context, emailVerificationTokenHash pgtype.Text) (User, error) {
...
SELECT id, email, email_verified, name, picture, password_hash, provider, google_id, failed_login_attempts, locked_until, created_at, updated_at, email_verification_token_hash, email_verification_expires_at FROM users WHERE google_id = $1
`
...
SELECT id, email, email_verified, name, picture, password_hash, provider, google_id, failed_login_attempts, locked_until, created_at, updated_at, email_verification_token_hash, email_verification_expires_at FROM users WHERE id = $1
`
