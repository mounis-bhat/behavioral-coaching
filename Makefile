...
# Code generation
swag:
	swag init -g main.go -o docs -d ./cmd/server,./internal/api,./internal/app/behavior,./internal/app/journal,./internal/app/chat,./internal/config,./internal/domain,./internal/storage
