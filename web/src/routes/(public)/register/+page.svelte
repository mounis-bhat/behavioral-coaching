...
<svelte:head>
	<title>Create account — Behavioral Coaching</title>
</svelte:head>
	...
	{#if visible}
		<div class="w-full max-w-sm">
			...
			>
				...
				<p class="mb-6 text-sm text-indigo-200/60">Start building better habits today</p>
				...
				>
					<div>
						<label for="name" class="mb-1.5 block text-sm font-medium text-indigo-200/80">Name</label>
						<input
							id="name"
							type="text"
							bind:value={name}
			...
			>
				...
				<a href={resolve('/login')} class="ml-1 text-indigo-300 transition hover:text-white">Sign in</a>
			</p>
		</div>
	{/if}
</div>
